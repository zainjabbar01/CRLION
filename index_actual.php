    ...
    <div id="carousel-wrapper">
      <div id="home-carousel" class="carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner">
          <div class="item active" style="background-image: url(images/bg_slider_1.jpg);">
            <div class="carousel-caption container">
              <p class="wow rotateInUpLeft" data-wow-delay="200ms"><span>NEW</span>. - AUGUST</p>
              <h1 class="wow rotateInUpLeft" data-wow-delay="400ms">Business Freelancer <span>Corporate Events<br>
                Best Seller Conferance...</span> </h1>
              <h3 class="wow rotateInUpLeft" data-wow-delay="600ms">Popular Business Ceo Conferance</h3>
               <a class="largeredbtn wow fadeInUpBig" data-wow-delay="800ms" href="#.">Register</a> <a class="largeredbtn wow fadeInUpBig" data-wow-delay="1000ms" href="#.">LEARN MORE</a> </div>
          </div>
  ...
  <div id="content"> 
    ...
    <div id="event_time">
      <div class="container">
        <ul>
          ...
          <!--======= Event Time =========-->
          <li> <span class="top-25">24 August</span> <br>
            <span class="big">2014</span> </li>
    ...
    <div id="register">
      <div class="overlay">
        ...
        <!--=======  Heading Tittle =========-->
        <div class="tittle wow flipInX" data-wow-duration="1s" data-wow-delay="800ms">
          <h2>EventGO! <span>Register</span></h2>
          <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy<br>
            text ever since the 1500s, when an.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse est odioconvallis. </p>
        </div>
      </div>
      ...
      <div class="register-input"> 
        ...
        <form role="form">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <button type="submit" class="form-control" >REGISTER EVENTS!</button>
              </div>
            </div>
          </div>
        </form>
      ...
      <div class="container">
        ...
        <div class="team">
          <ul class="row grid">
            ...
            <!--=======  Member 1 =========-->
            <li class="col-md-4">
              <div class="figure effect-oscar"> <img src="images/team-1.png" alt=""/>
            ...
            <!--=======  Member 2 =========-->
            <li class="col-md-4">
              <div class="figure effect-oscar"> <img src="images/team-2.png" alt=""/>
                <div class="figcaption">
                  <p> <a href="#." class="fb"> <span class="ion-social-facebook"></span></a> <a href="#." class="tw"> <span class="ion-social-twitter"></span></a> <a href="#." class="linkedin"> <span class="ion-social-linkedin-outline"></span> </a></p>
                </div>
            ...
            <!--=======  Member 3 =========-->
            <li class="col-md-4">
              <div class="figure effect-oscar"> <img src="images/team-3.png" alt=""/>
                <div class="figcaption">
                  <p> <a href="#." class="fb"> <span class="ion-social-facebook"></span></a> <a href="#." class="tw"> <span class="ion-social-twitter"></span></a> <a href="#." class="linkedin"> <span class="ion-social-linkedin-outline"></span> </a></p>
                </div>
            ...
            <!--=======  Member 4 =========-->
            <li class="col-md-4">
              <div class="figure effect-oscar"> <img src="images/team-4.png" alt=""/>
                <div class="figcaption">
                  <p> <a href="#." class="fb"> <span class="ion-social-facebook"></span></a> <a href="#." class="tw"> <span class="ion-social-twitter"></span></a> <a href="#." class="linkedin"> <span class="ion-social-linkedin-outline"></span> </a></p>
                </div>
            ...
            <!--=======  Member 5 =========-->
            <li class="col-md-4">
              <div class="figure effect-oscar"> <img src="images/team-5.png" alt=""/>
                <div class="figcaption">
                  <p> <a href="#." class="fb"> <span class="ion-social-facebook"></span></a> <a href="#." class="tw"> <span class="ion-social-twitter"></span></a> <a href="#." class="linkedin"> <span class="ion-social-linkedin-outline"></span> </a></p>
                </div>
            ...
            <!--=======  Member 6 =========-->
            <li class="col-md-4">
              <div class="figure effect-oscar"> <img src="images/team-6.png" alt=""/>
                <div class="figcaption">
                  <p> <a href="#." class="fb"> <span class="ion-social-facebook"></span></a> <a href="#." class="tw"> <span class="ion-social-twitter"></span></a> <a href="#." class="linkedin"> <span class="ion-social-linkedin-outline"></span> </a></p>
                </div>
    ...
    <div id="partner">
      ...
      <div class="partner">
        <div class="container"> 
          ...
          <nav>
            <ul class="nav nav-tabs nav-pills" role="tablist">
              <li class="active"><a href="#silver" role="tab" data-toggle="tab">Silver Sponsors</a></li>
              <li><a href="#gold" role="tab" data-toggle="tab"> Gold Sponsors </a></li>
              <li><a href="#platin" role="tab" data-toggle="tab">Platin Sponsors</a></li>
            </ul>
          </nav>
          <!-- Tab panes -->
          <div class="tab-content">
            <div class="tab-pane fade in active" id="silver"> <img src="images/sponser-img.jpg" alt=""> </div>
            <div class="tab-pane fade" id="gold"> <img src="images/sponser-img-1.jpg" alt=""> </div>
            <div class="tab-pane fade" id="platin"> <img src="images/sponser-img.jpg" alt=""> </div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="price_table">
      <div class="container">
        ...
        <!--=======  Heading Tittle =========-->
        <div class="tittle wow flipInX" data-wow-duration="1s" data-wow-delay="800ms">
          <h2>EventGO! <span>Pricing Tables</span></h2>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit eaque dolorem fugiat ullam ea! Perspiciatis, ipsum ea possimus voluptatem sequi 
            amet harum dolores commodi eveniet earum est expedita error ab.</p>
        </div>
