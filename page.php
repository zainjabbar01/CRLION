...
<body id="index">
    ...
    <? //echo '<pre>';print_r($slider_data);?>
    <!-- Hero Section -->
     <section id="social-icons" class="light">
		<div class="container">
            ...
            <div style="float: right;">
            	<ul class="nav-bar">
                      <li style="display:<?=($home_data['twitter'])?'':"none"?>"><a href="<?=$home_data['twitter']?>"><span class="fa fa-twitter"></span></a>
                      <li style="display:<?=($home_data['facebook'])?'':"none"?>"><a href="<?=$home_data['facebook']?>"><span class="fa fa-facebook"></span></a>
                      <li style="display:<?=($home_data['pinterest'])?'':"none"?>"><a href="<?=$home_data['pinterest']?>"><span class="fa fa-pinterest-square"></span></a>
                      <li style="display:<?=($home_data['linkedin'])?'':"none"?>"><a href="<?=$home_data['linkedin']?>"><span class="fa fa-linkedin-square"></span></a>
                      <li style="display:<?=($home_data['googleplus'])?'':"none"?>"><a href="<?=$home_data['googleplus']?>"><span class="fa fa-google-plus"></span></a>
      ...
      <div class="container">
        <nav class="navigation">
          ...
          <ul class="navigation-bar navigation-bar-left">
            <li><a href="http://<?=$_SERVER['HTTP_REFERER']?>" >Home</a></li>
             
			<?php
			  echo $pages;
			?>
            <? /* <li><a href="http://<?=$_SERVER['HTTP_HOST']?>/mm_sites/CustomerEventPage/index/0/<?=$event_id?>" >Contact</a></li> */ ?>
          </ul>
        </nav>
      </div>
              ...
              <div class="container">
                <section class="vc-example">
                  <article class="article-big">
                    ...
                    <div class="big"><?=$page['page_content']?></div>
                  </article>
                </section>
              </div>
    		</section> 
    ...
    <section id="map" class="dark">
		<div id="canvas-map"><?php if(isset($home_data['map_info']->html)){echo $home_data['map_info']->html;}?></div>
		<div class="container">
			<div class="row">
				<div class="col-md-5 col-sm-7 animated hiding location" data-animation="fadeInLeft" data-delay="0">
					<h3>Location</h3>												
                    	<ul itemscope="" itemtype="http://schema.org/PostalAddress">
							<li itemprop="address"><i class="fa fa-map-marker highlight"></i><?=$eventData['location'];?></li>
							<li itemprop="email"><i class="fa fa-envelope highlight"></i><?=$eventData['email'];?></li>
							<li itemprop="telephone"><i class="fa fa-phone highlight"></i><?=$eventData['contact_number'];?></li>
