          ...
          <div class="item active" style="background-image: url(<?=PROJECT_PATH?>assets/customer_events/template1/images/bg_slider_1.jpg);">
            <div class="carousel-caption container">
              ...
              <h3 class="wow rotateInUpLeft" data-wow-delay="600ms"><? if(strlen($eventData['event_desc']) > 500) echo strip_tags(substr($eventData['event_desc'],0, 500)) . '...'; else echo strip_tags($eventData['event_name']); ?></h3>
              	...
              	<a class="largeredbtn wow fadeInUpBig" data-wow-delay="800ms" href="<?=$eventData['event_video']?>">WATCH VIDEO</a> 
...
<div id="loginRegModal" tabindex="-1" style="width:450px; padding:30px; min-height:250px; display:none">
    ...
    <div class="row">
        <div class="col-xs-12 text-center">
            <a href="#" class="btn btn-success" onClick="$('#loginRegModal').modal('hide'); $('#loginModal').modal('show'); " style="width:130px; height:35px; font-size:14px;">Yes</a>
             &nbsp; 
            <a href="#" class="btn btn-primary" onClick="$('#loginRegModal').modal('hide'); $('#regModal').modal('show'); " style="width:130px; height:35px; font-size:14px;">No</a>
        </div>
    </div>
</div>
...
$( document ).ready(function() {   
	...
	$("#regModal").dialog({
		...
		modal: true,		
		width: 500,	
		title: 'Register',		 //'Groups / Employees List',
		open: function(ev, ui){
	...
	$("#loginModal").dialog({
		...
		modal: true,		
		width: 500,
		title: 'Login', //'Groups / Employees List',			
		open: function(ev, ui){
			//$('#myIframe').attr('src','selectRecipients.php');
			//frames['myIframe'].getDefaultSelection();
		}, 
	...
	$('.login-popup-window').click(function(){
