...
<div id="wrap"> 
  ...
  <header id="header" class="sticky">
    <div class="container">
      <div class="menu">
        <div class="logo"> <a href="#wrap"> <img src="<?=$home_data['image_site'].$home_data['logo'].'?id='.rand(0,10)?>" alt=""> </a> </div>
		...
		?>
          <div class="item <?=$dec_class?>" style="background-image: url(<?=$home_data['image_site'].$slider_arr['slider_image']?>);">
            <div class="carousel-caption container">
              ...
              <h3 class="wow rotateInUpLeft" data-wow-delay="600ms"><? if(strlen($eventData['event_desc']) > 500) echo strip_tags(substr($eventData['event_desc'],0, 500)) . '...'; else echo strip_tags($eventData['event_desc']); ?></h3>
              	
              	<a class="largeredbtn wow fadeInUpBig popup-vimeo" data-wow-delay="800ms" href="<?=$eventData['event_video']?>">WATCH VIDEO</a> 
               	<a class="largeredbtn wow fadeInUpBig register-popup-window" data-wow-delay="1000ms" href="#">Register</a>
             </div>
          </div>
          <?
		  /*
    ...
    <div class="rights">
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-6">
            <p class="align-right">All Rights Reserved. © <?=date('Y')?></p>
          </div>
        </div>
      </div>
    </div>
...
<script src="<?=PROJECT_PATH?>assets/js/plugins/jquery-ui/jquery-ui.min.js"></script> <? #dialog close button issue so after bootstrap ?>
...
<div id="loginRegModal" tabindex="-1" style="width:450px; padding:30px; min-height:250px; display:none">
    <p>&nbsp;</p>
    <div class="row">
        <div class="col-xs-12 text-center" style="font-size:22px;">
    ...
    <div class="row">
        <div class="col-xs-12 text-center">
            <a href="#" class="btn btn-success" onClick="$('#loginRegModal').dialog('close'); $('#loginModal').dialog('open'); " style="width:130px; height:35px; font-size:14px;">Yes</a>
             &nbsp; 
            <a href="#" class="btn btn-primary" onClick="$('#loginRegModal').dialog('close'); $('#regModal').dialog('open'); " style="width:130px; height:35px; font-size:14px;">No</a>
        </div>
    </div>
</div>
<div id="regModal" style="display:none;">
    <iframe name="myIframe" id="myIframe" src="<?=PROJECT_PATH?>register" frameborder="0" style="width:100%; border:0px;height:415px;"></iframe>
</div>
...
$( document ).ready(function() {   
	...
	$('.register-popup-window').click(function(){
		$('#loginRegModal').dialog('open');
	});
