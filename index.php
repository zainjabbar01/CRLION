...
<body id="index">
        ...
        <div class="home-bg">
          <nav class="navigation navigation-social">
            <ul class="navigation-bar">
              <li style="display:<?=($home_data['twitter'])?'':"none"?>"><a target="_blank" href="<?=$home_data['twitter']?>"><span class="fa fa-twitter"></span></a>
              <li style="display:<?=($home_data['facebook'])?'':"none"?>"><a target="_blank" href="<?=$home_data['facebook']?>"><span class="fa fa-facebook"></span></a>
              <li style="display:<?=($home_data['pinterest'])?'':"none"?>"><a target="_blank" href="<?=$home_data['pinterest']?>"><span class="fa fa-pinterest-square"></span></a>
              <li style="display:<?=($home_data['linkedin'])?'':"none"?>"><a target="_blank" href="<?=$home_data['linkedin']?>"><span class="fa fa-linkedin-square"></span></a>
              <li style="display:<?=($home_data['googleplus'])?'':"none"?>"><a target="_blank" href="<?=$home_data['googleplus']?>"><span class="fa fa-google-plus"></span></a>
          ...
          <div class="hero-content text-center ">
            ...
            <a id="reg" data-toggle="modal" data-target="#regModal" class="btn btn-sm btn-default" style="width:180px;">Register</a>
            <a href="#login" data-toggle="modal" data-target="#loginModal" class="btn btn-sm btn-default" style="width:180px;">Login</a>
            <?php
			}
			?>
          </div>          
        ...
        <nav class="navigation">
          ...
          <ul class="navigation-bar navigation-bar-left">
			...
			<?php
			  echo $pages;
			?>
            <li class="featured"><a id="regis" data-toggle="modal" data-target="#regModal" href="#register"><i class="fa fa-ticket fa-1x"></i>Register</a></li>
            <li class="featured"><a href="#login" data-toggle="modal" data-target="#loginModal"><i class="fa fa-ticket fa-1x"></i>Login</a></li>
          </ul>
        </nav>
      </div>      
    </header>
				...
				<div class="col-md-5 col-sm-7 animated hiding location" data-animation="fadeInLeft" data-delay="0">
					<h3>Location</h3>
                        <ul itemscope="" itemtype="http://schema.org/PostalAddress">
							...
							<li itemprop="email"><i class="fa fa-envelope highlight"></i><?=$home_data['email']?></li>
							<li itemprop="telephone"><i class="fa fa-phone highlight"></i><?=$home_data['phone']?></li>
						</ul>
				</div>
			</div>
		</div>
        	...
        	<div class="modal-content animated bounceInRight">
            	<div class="modal-header">
                 ...
                 <div class="modal-body">
                 	<form role="form" method="post" name="formEmail">
						<? require("login.php") ?>
                    </form>
                 </div>
            </div>
    ...
    <div class="modal inmodal" id="regModal" tabindex="-1" role="dialog" aria-hidden="true">
    	<div class="modal-dialog modal-md" style="width:500px;">
        	<div class="modal-content animated bounceInRight">
            	<div class="modal-header">
                 ...
                 <div class="modal-body">
                 	<iframe name="myIframe" id="myIframe" src="<?=PROJECT_PATH?>register" frameborder="0" style="width:100%; border:0px;height:475px;"></iframe>
                 </div>
            </div>
        </div>
    </div>
