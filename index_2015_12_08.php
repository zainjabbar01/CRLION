...
<!--Main-->
<link rel="stylesheet" href="<?=PROJECT_PATH?>assets/customer_events/template1/css/bootstrap.min.index.css" type="text/css" media="all" />
...
<div id="wrap"> 
        ...
        <div class="carousel-inner">
          <div class="item active" style="background-image: url(<?=PROJECT_PATH?>assets/customer_events/template1/images/bg_slider_1.jpg);">
            <div class="carousel-caption container">
              ...
              <h3 class="wow rotateInUpLeft" data-wow-delay="600ms"><? if(strlen($eventData['event_desc']) > 500) echo substr($eventData['event_desc'],0, 500) . '...'; else echo $eventData['event_name']?></h3>
  ...
  <div id="content"> 
    ...
    */ ?>
    <div class="modal inmodal" id="loginRegModal" tabindex="-1" role="dialog" aria-hidden="true">
    	<div class="modal-dialog" style="width:450px;">
        	<div class="modal-content animated bounceInRight">
            	<div class="modal-header">
                 ...
                 <div class="modal-body" style="padding:30px; min-height:250px;">
                 	<p>&nbsp;</p>
                    <div class="row">
